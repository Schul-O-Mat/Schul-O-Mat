          ...
          @if(!Auth::guest())
              <div class="col s12">
                  ...
                  <div class="row center-align">
                          <a href="{{ action("BackendController@neueSchule") }}" class="btn large blue">Fehlt eine Schule?</a>
                  </div>
              </div>
          @endif
          <div class="col s12">
              <p class="flow-text">Dein Account</p>
              <div class="row center-align">
                  @if(Auth::guest())
