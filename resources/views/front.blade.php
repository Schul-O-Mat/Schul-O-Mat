  ...
  <main class="container">
      <div class="row">
          ...
          <div class="col s12">
              ...
              <div class="row center-align">
                  @if(Auth::guest())
                  <a href="{{ action("Auth\AuthController@getLogin") }}" class="btn large blue">Log dich ein</a>
                  <a href="{{ action("Auth\AuthController@getRegister") }}" class="btn large blue">Registriere dich beim Schul-O-Maten</a> @else
