...
@section("main")
  <div class="row">
    <div class="col s12">
      <ul class="pagination">
        @if ($zurueck)
          <li class="waves-effect"><a href="{{ action("SchulMasterController@paginationFilter", ["page" => $page-1, "ort" => $ort, "schulart" => $schulart, "schulform" => $schulform]) }}"><i class="material-icons">chevron_left</i></a></li>
        @else
          <li class="waves-effect disabled"><a><i class="material-icons">chevron_left</i></a></li>
        @endif @if ($weiter)
          <li class="chevron_right waves-effect"><a href="{{ action("SchulMasterController@paginationFilter", ["page" => $page+1, "ort" => $ort, "schulart" => $schulart, "schulform" => $schulform]) }}"><i class="material-icons">chevron_right</i></a></li>
        @else
